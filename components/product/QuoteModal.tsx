...
export default function QuoteModal({ show, onHide, motorcycleId, motorcycleName }: QuoteModalProps) {
  ...
  const onSubmit = async (data: Record<string, unknown>) => {
    try {
      ...
      toast.success(locale === "fr" ? "Demande de devis envoyée !" : "Quote request sent!");
      reset();
      onHide();
    } catch {
  ...
  return (
    <Modal show={show} onHide={onHide} centered size="lg">
      <Modal.Header closeButton>
        <Modal.Title>{locale === "fr" ? "Demander un devis" : "Request a quote"}</Modal.Title>
      </Modal.Header>
